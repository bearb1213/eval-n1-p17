<?php
/* Smarty version 4.3.4, created on 2026-05-05 16:54:04
  from 'D:\prog\eval\eval-n1-p17\prestashop\admin\themes\default\template\controllers\login\content.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.4',
  'unifunc' => 'content_69f9f67c64e3a4_94675437',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '35dc6ff1f6bb950d4a26c6d9b487ef044e0e16f8' => 
    array (
      0 => 'D:\\prog\\eval\\eval-n1-p17\\prestashop\\admin\\themes\\default\\template\\controllers\\login\\content.tpl',
      1 => 1777268640,
      2 => 'file',
    ),
  ),
...
function content_69f9f67c64e3a4_94675437 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'D:\\prog\\eval\\eval-n1-p17\\prestashop\\vendor\\smarty\\smarty\\libs\\plugins\\modifier.date_format.php','function'=>'smarty_modifier_date_format',),));
?>
<div id="login-panel">
	<div id="login-header">
		<h1 class="text-center">
			<img id="logo" src="<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['img_dir']->value,'html','UTF-8' ));?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
		...
		<div class="alert alert-warning"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['warningSslMessage']->value,'html','UTF-8' ));?>
</div>
		<?php }?>
	</div>
	<div id="shop-img"><img src="<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['img_dir']->value,'html','UTF-8' ));?>
preston-login@2x.png" alt="<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['shop_name']->value,'html','UTF-8' ));?>
	...
	<div class="flip-container">
		<div class="flipper">
			<div class="front front_login panel" <?php if ((isset($_smarty_tpl->tpl_vars['reset_token']->value)) && (isset($_smarty_tpl->tpl_vars['id_employee']->value))) {?>style="display:none;"<?php }?>>
				<h4 id="shop_name"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['shop_name']->value,'html','UTF-8' ));?>
</h4>
				<?php if (!(isset($_smarty_tpl->tpl_vars['wrong_folder_name']->value)) && !(isset($_smarty_tpl->tpl_vars['wrong_install_name']->value))) {?>
				<form action="#" id="login_form" method="post">
					<input type="hidden" name="redirect" id="redirect" value="<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['redirect']->value,'html','UTF-8' ));?>
"/>
...
">
  ...
  <a class='login-back' href='<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['homeUrl']->value,'html','UTF-8' ));?>
...
</span> <span class="login-back-shop"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['shop_name']->value,'html','UTF-8' ));?>
</span></a>
