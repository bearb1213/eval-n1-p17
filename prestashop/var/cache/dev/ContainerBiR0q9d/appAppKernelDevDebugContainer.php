...
class appAppKernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->methodMap = [
            ...
            'PrestaShopBundle\\Twig\\RawPurifiedExtension' => 'getRawPurifiedExtensionService',
            ...
            'prestashop.utils.html_purifier' => 'getPrestashop_Utils_HtmlPurifierService',
    ...
    /**
     * Gets the public 'PrestaShopBundle\Twig\RawPurifiedExtension' shared service.
     *
     * @return \PrestaShopBundle\Twig\RawPurifiedExtension
     */
    protected function getRawPurifiedExtensionService()
    {
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('J28oDWy8U-', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('8savTj95JP', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    /**
     * Gets the public 'prestashop.utils.html_purifier' shared autowired service.
     *
     * @return \PrestaShopBundle\Utils\HTMLPurifier
     */
    protected function getPrestashop_Utils_HtmlPurifierService()
    {
        return $this->services['prestashop.utils.html_purifier'] = new \PrestaShopBundle\Utils\HTMLPurifier();
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\AssetExtension(new \Symfony\Component\Asset\Packages(new \Symfony\Component\Asset\PathPackage('', new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('8.2.6', '%s?%s'), new \Symfony\Component\Asset\Context\RequestStackContext($d, '', false)), [])));
        ...
        $instance->addExtension(($this->services['PrestaShopBundle\\Twig\\RawPurifiedExtension'] ?? $this->getRawPurifiedExtensionService()));
    ...
    {
        return $this->privates['api_platform.cache.metadata.property'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('QOKFW5FG8V', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property.legacy'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('EPbgEFa0ET', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('rOvliNb+Bo', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource.legacy'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('TB0GHtIJ73', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource_collection'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('FkzlzecUIh', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['api_platform.cache.route_name_resolver'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ZDGaNv10Sd', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('W0HFv4rQoR', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('3be4GmsmOp', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Hu5CYoq1UP', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ZdDk0fgQw0', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('q02ONTf6Pw', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(($this->privates['uri_signer'] ?? ($this->privates['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('NDWDBAH9WtPMOgqINgJqDTxkRMKwGYGCPuStUeVZwKDbOn6DT24mE1Eh2Hbw8buv'))), '/_fragment');
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'secret' => 'NDWDBAH9WtPMOgqINgJqDTxkRMKwGYGCPuStUeVZwKDbOn6DT24mE1Eh2Hbw8buv',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2026-05-05',
            'locale' => 'fr-FR',
            'use_debug_toolbar' => true,
            'cookie_key' => '8nZhzHC98f1ELCD2nnXarDtyLkRb0imzUJQsE55qmkhbnub5ZT3sdj8uWLp452H5',
            'cookie_iv' => 'oP56LIPkLggJYWWFupyJBeEzdPz7GCE1',
            'new_cookie_key' => 'def000004a76db9189f9cd4dc32bf3bd713237b0872c210a18889d3ebd72adfc94f93228380ae265575257872968b7fa3d79e75b9e8943a99fd433586c38a2ca3890cdbf',
            ...
            'api_private_key' => '-----BEGIN PRIVATE KEY-----'."\n".'MIIEvgIBADANBgkqhkiG9w0BAQEFAASCBKgwggSkAgEAAoIBAQDRnPGL39d+xgeV'."\n".'LGGLED0c/aGqBwUD05RcqQgBxqllthMNRhMZJeAHnXZ/DZ+Kpv1kW8b42vNNFGNX'."\n".'b+E+nAR2RB2ds5dYXSBsM312yJ85F7p+fLCD8uP57fbABRTOa6hk2KwQW3cxluOl'."\n".'GNOtRRpvgGRv+zkldvwqTu8zAtHTg0FXgNiulU56gPyp0M3yVbh7Pcn1hq9GEpem'."\n".'1F7EGad/78ookXHxQW1QvRCbAaVBI9fNcl9qzGAg0UTp8S2eFwwvI+0yirCT9nFk'."\n".'u93AowZmrB8X7elTwq3XJMSOTYfeV3yfmramiHdsX3iXGO2VplZ2D80RtdNLMwRR'."\n".'Zcc/SIKbAgMBAAECggEABEArgcujQhXf931z6O8GXj0idyE3T9GNk6d