...
class __TwigTemplate_0fa7b5fccb36f9fd1809727e9ee5cb405d30e4b39696bd4f65838d66677ea361 extends Template
{
    private $source;
    private $macros = [];
      ...
      <em>
        ";
            ...
            if ((isset($context["isRecommandedType"]) || array_key_exists("isRecommandedType", $context) ? $context["isRecommandedType"] : (function () { throw new RuntimeError('Variable "isRecommandedType" does not exist.', 29, $this->source); })())) {
                // line 30
                echo "          ";
                echo $this->extensions['PrestaShopBundle\Twig\RawPurifiedExtension']->rawPurifier(twig_replace_filter($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("[1][/1] of [2][/2] characters used (recommended)", [], "Admin.Catalog.Feature"), ["[1]" => "<span class=\"currentLength\">", "[/1]" => "</span>", "[2]" => ("<span class=\"currentTotalMax\">" . twig_get_attribute($this->env, $this->source,                 // line 33
(isset($context["attr"]) || array_key_exists("attr", $context) ? $context["attr"] : (function () { throw new RuntimeError('Variable "attr" does not exist.', 33, $this->source); })()), "counter", [], "any", false, false, false, 33)), "[/2]" => "</span>"]));
        ...
        ";
                ...
                // line 37
                echo "          ";
                echo $this->extensions['PrestaShopBundle\Twig\RawPurifiedExtension']->rawPurifier(twig_replace_filter($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("[1][/1] of [2][/2] characters allowed", [], "Admin.Catalog.Feature"), ["[1]" => "<span class=\"currentLength\">", "[/1]" => "</span>", "[2]" => ("<span class=\"currentTotalMax\">" . twig_get_attribute($this->env, $this->source,                 // line 40
...
{% endif %}
", "@Twig/form_max_length.html.twig", "D:\\prog\\eval\\eval_n1\\prestashop\\src\\PrestaShopBundle\\Resources\\views\\Admin\\TwigTemplateForm\\form_max_length.html.twig");
    }
}
